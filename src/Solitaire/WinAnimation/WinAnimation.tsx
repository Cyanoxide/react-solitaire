...
// Served from the host's web root (react-xp already ships it in public/; the
// standalone app ships it in its own public/).
...
const WinAnimation = ({ foundations, onCardLaunch, onComplete }: WinAnimationProps) => {
    ...
    // Keep the callbacks fresh without re-running the animation effect
    useEffect(() => {
